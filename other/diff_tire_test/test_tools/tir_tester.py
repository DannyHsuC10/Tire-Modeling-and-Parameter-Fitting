...
if __name__ == "__main__":
    # load data
    df = load_mf_data("Filtered_data/B2356run4_processed234.csv")# 輸入與輸出結果
    #df = load_mf_data("csv/B2356run8.csv")# 輸入與輸出結果
    tir_params1 = MF_tester.load_tir("D2704_mf612.tir")# 紅心
    tir_params2 = MF_tester.load_tir("tir_Fitting_results.tir")# 我
    # plot
